...
def MakeRelativePathsInFlagsAbsolute(flags_in, working_directory):
    if not working_directory:
        return list(flags_in)
    new_flags = []
...
# a file.
def FlagsForFile(filename, **_):  # **kwargs not used, use "_"(underscore) to denote it.
    if database:
