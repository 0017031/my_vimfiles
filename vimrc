...
if has('nvim') 
  ...
  if  filereadable($VIMRUNTIME . "/defaults.vim") | source $VIMRUNTIME/defaults.vim | let g:skip_defaults_vim = 1 |endif
...
set t_vb=  "don't flash my screen
...
aug MYFILE
  ...
  au Filetype  gitconfig  setlocal tabstop=2 sts=2 sw=2 "formatoptions-=ro " Don't insert a " at the start of the new line.	
